...
class RepositoryTest {
    ...
    public void getFirstPhoneRecord(){
        ...
        AssertionsForClassTypes.assertThat(person.get(0).getId()).isEqualTo(1);
        AssertionsForClassTypes.assertThat(person.get(0).getAddresses().size()).isEqualTo(2);
    }
    ...
    public void deleteAddress(){
        ...
        var people = personRepository.findAll();
        AssertionsForClassTypes.assertThat(people.get(1).getAddresses().size()).isEqualTo(0);
        AssertionsForClassTypes.assertThat(people.get(0).getAddresses().size()).isEqualTo(1);
